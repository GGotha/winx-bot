...
fs.readdir("./src/commands/", (error, files) =>{
  ...
  jsfile.forEach((f, i) => {
    var props = require(`./src/commands/${f}`)
...
client.on(`guildMemberAdd`, member => {
    ...
    if(member) {
      ...
      member.send("```Bem-Vindo ao WINX Team! Eu sou o BOT principal do servidor, qualquer dúvida pode falar com o meu criador, o Gotha\n\nPara me chamar só digitar wx!comandos, no canal BOT, no meu servidor```")
    }else {
