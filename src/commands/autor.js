...
module.exports.run = async (client, message, args) => {
   ...
   let gotha = `${message.author}`;
    ...
    .setDescription("Meu criador, fui desenvolvida em javascript, mas especificamente node.js.\n OBS: A foto do meu criador, ele só tem essa foto")
    .setColor("#FF00FF")
    .setAuthor("Criado por Gotha")
    .setImage(url = 'https://cdn.discordapp.com/attachments/558112016771055626/558330513191075840/A67Jal5.jpg')
    .setTimestamp()
    .setFooter(
        'Since 2014',
